...
public class Parser {
    ...
    public Command getCommand(final String pInputLine) {
        ...
        if (tokenizer.hasMoreTokens()) {
            vWord2 = pInputLine.substring(pInputLine.indexOf(vWord1) + vWord1.length() + 1); //if more than 2 word, put everything in word 2
    ...
    /**
     * Shows the list of the valid commands
     */
